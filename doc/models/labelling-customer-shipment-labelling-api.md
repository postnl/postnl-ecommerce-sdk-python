...
| `customs` | [`CustomsLabellingAPI`](../../doc/models/customs-labelling-api.md) | Optional | The Customs type is mandatory for non-EU shipments and not allowed for any other shipment types. |
