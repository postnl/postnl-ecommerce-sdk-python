...
| `product_code_delivery` | [`str`](../../doc/models/string-enum.md) | Required | Product code of the shipment. See the [Products page](https://developer.postnl.nl/docs/#/http/reference-data/product-codes) for possible products.<br>**Default**: `'3085'`<br>**Constraints**: *Pattern*: `^\d{4,5}$` |
