...
class ShipmentControllerTests(ControllerTestBase):

    controller = None

    @classmethod
    def setUpClass(cls):
        super(ShipmentControllerTests, cls).setUpClass()
        cls.controller = cls.client.shipment
        cls.response_catcher = cls.controller.http_call_back

    # Generate a label and confirmation
    def test_generate_shipment_label(self):
        ...
        result = self.controller.generate_shipment_label(body, confirm)
